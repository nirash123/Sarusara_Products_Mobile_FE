  ...
  <b-row class="m-2">
      ...
      <b-overlay :show="tableLoading" rounded="sm">
        ...
        >
          ...
          <template #cell(user_name)="data">
            ...
            <div v-else> N / A</div>
            <div v-if="data.item.note"> {{ data.item.note }} </div>
          </template>


          <template #cell(cheque_type)="data">
              <b-badge v-if="data.item.cheque_type == '2' " class="ml-1" style="padding: 8px" variant="light-primary">
                  Purchase Order
              </b-badge>
              <b-badge v-if="data.item.cheque_type == '3' " class="ml-1" style="padding: 8px" variant="light-warning">
    ...
    <template  #cell(actions)="data">
      ...
      <div v-if="data.item.active_status == 1" class="text-nowrap">
        <b-button
          variant="success"
          @click="$router.push({ name: 'edit-cheque-payment-details', params: { id: data.item.id }})"
        >
  ...
  methods: {
    ...
    async getUsers() {
      try {
        ...
        const Response = await payment.getPaymentExpenditureCheques(
        ...
        try {
          ...
          this.$swal({
            ...
            if (result.value) {
             ...
             await payment.payExpenditureCheque(id, this.payload)
