      ...
      <b-overlay :show="tableLoading" rounded="sm">
        ...
        <template #cell(users_user_name)="data">
          ...
          <template #cell(card_type)="data">
            <b-badge v-if="data.item.card_type == '1' " class="ml-1" style="padding: 8px" variant="light-primary">
                Sell Order
            </b-badge>
            <b-badge v-if="data.item.card_type == '4' " class="ml-1" style="padding: 8px" variant="light-success">
                Plastic Sell Order
            </b-badge>
  ...
  methods: {
    async getUsers() {
      try {
        ...
        const Response = await payment.getPastIncomeCards(
