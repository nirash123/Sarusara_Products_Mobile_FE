      ...
      <b-overlay :show="tableLoading" rounded="sm">
        ...
        <template  #cell(actions)="data">
                ...
                <feather-icon
                  ...
                  icon="EyeIcon"
                  size="16"
                  @click="$router.push({ name: 'view-payment-sell-sale-order', params: { id: data.item.order_id }})"
                />
                </b-button>
                <b-button v-if="data.item.credit_type == '4'"
                                  v-ripple.400="'rgba(255, 255, 255, 0.15)'"
                                  variant="outline-primary"
                                  class="btn-icon mr-50"
                                >
                <feather-icon
                  ...
                  icon="EyeIcon"
                  size="16"
                  @click="$router.push({ name: 'view-payment-sell-plastic-sale-order', params: { id: data.item.order_id }})"
                />
                </b-button>
  ...
  methods: {
    async getUsers() {
      try {
        ...
        const Response = await payment.getTodayIncomeCredits(
