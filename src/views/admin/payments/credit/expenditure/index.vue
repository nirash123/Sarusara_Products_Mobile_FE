        ...
        <b-overlay :show="tableLoading" rounded="sm">
          ...
          <template #cell(users_user_name)="data">
            ...
            <template #cell(credit_type)="data">
              <b-badge v-if="data.item.credit_type == '2' " class="ml-1" style="padding: 8px" variant="light-primary">
                  Purchase Order
              </b-badge>
              <b-badge v-if="data.item.credit_type == '3' " class="ml-1" style="padding: 8px" variant="light-warning">
          ...
          <template  #cell(actions)="data">
                ...
                <div  class="text-nowrap">
                  <b-button v-if="data.item.credit_type == '2' "
                ...
                <b-button v-if="data.item.credit_type == '3' "
                                  v-ripple.400="'rgba(255, 255, 255, 0.15)'"
                                  variant="outline-primary"
                                  class="btn-icon mr-50"
                                >
                <feather-icon
                  ...
                  icon="EyeIcon"
                  size="16"
                  @click="$router.push({ name: 'view-payment-plastic-purchase-order', params: { id: data.item.order_id }})"
                />
                </b-button>
    ...
    methods: {
      async getUsers() {
        try {
          ...
          const Response = await payment.getTodayExpenditureCredits(
