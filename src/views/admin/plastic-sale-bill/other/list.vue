  ...
  <div class="fixed-page">
    <section class="invoice-preview-wrapper">
      <b-card no-body class="invoice-actions p-1 bg-primary rounded p-1">
        <b-row>
          <b-col cols="1">
            <feather-icon @click="$router.push('/plastic-sale-order_list?tab=2')" icon="ChevronLeftIcon" class="text-white" size="54" />
          </b-col>
          <b-col cols="10">
            <h3 class="text-white d-flex justify-content-center">
              <span class="mt-1 text-white">Past Plastic Sale Order ( {{ orders.plastic_sale_orders_bill_number }} )  </span>
            </h3>
          </b-col>
        </b-row>
      </b-card>
            ...
            <b-col cols="12">
              <div>
                ...
                <b-row>
                  ...
                  <b-col cols="6">
                    <h6 class="font-weight-bolder display-new-8">
                      Supplier <span class="ml-5"> <span class="ml-50">: {{ orders.suppliers_supplier_name.substring(0, 22) }} </span></span>
                    </h6>
                  </b-col>
                   <b-col cols="6">
                    <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                  ...
                  <b-col cols="6" class="pl-5">
                    <div class="payment-box">
                      <div class="payment-row display-new-73">
                        ...
                        <span> {{ formatPrice(orders.plastic_sale_orders_total) }}</span>
                      </div>
                      <div class="payment-row display-new-70">
                        <span>Amount Paid </span>
                        <span> {{ formatPrice(orders.plastic_sale_orders_transpoart) }}</span>
                      </div>
                      <div v-if="orders.plastic_sale_orders_hold > 0" class="payment-row display-new-70">
                        <span>Company Payment </span>
                        <span> {{ formatPrice(orders.plastic_sale_orders_hold) }}</span>
                      </div>
                      <div class="payment-row display-new-70">
                        <span> Change Rs. </span>
      ...
      try {
        ...
        this.$swal({
          ...
          if (result.value) {
            ...
            this.$router.push('/plastic-sale-order_list')
            this.refreshTable();
