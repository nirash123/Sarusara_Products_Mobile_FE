  ...
  <div class="fixed-page">
    <section class="invoice-preview-wrapper">
      <b-card no-body class="invoice-actions p-1 bg-primary rounded p-1">
        <b-row>
          <b-col cols="1">
            <feather-icon @click="$router.push('/plastic-order_list?tab=2')" icon="ChevronLeftIcon" class="text-white" size="54" />
          </b-col>
          <b-col cols="10">
            <h3 class="text-white d-flex justify-content-center">
              <span class="mt-1 text-white">Past Plastic Purchase Order ( {{ orders.plastic_purchase_orders_bill_number }} ) </span>
            </h3>
          </b-col>
        </b-row>
      </b-card>
        ...
        <b-col lg="6" md="6" sm="12" class="mb-2">
          ...
          <span class="ml-1">
            <b-button v-if="orders.plastic_purchase_orders_active_status == 0" :class="{ 'btn-loading': isLoading }"
              ...
              @click="deleteOrder(orders.plastic_purchase_orders_id)">
              <span v-if="isLoading">Loading...</span>
      ...
      <b-card style="height: 805px;" class="invoice-actions">
        ...
        <div>
          <h4 class="d-flex align-items-center justify-content-start mb-1">
            Order Items List : ( Rs: {{
              (orders.plastic_purchase_orders_total).toString(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
            )
          </h4>
        </div>
                  ...
                  <b-row>
                    ...
                    <b-col cols="6">
                      <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                        Invoice Date <span class="ml-3"> : {{ formatDate(orders.plastic_purchase_orders_order_date) }}
                        </span>
                      </h6>
                      <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                  ...
                  <b-col cols="6" class="pl-5">
                    <div class="payment-box">
                      ...
                      <div class="payment-row display-new-70">
                        ...
                        <span> {{ formatPrice(orders.plastic_purchase_orders_transpoart) }}</span>
                      </div>
                      <div v-if="orders.plastic_purchase_orders_hold > 0" class="payment-row display-new-70">
                        <span>Company Payment </span>
                        <span> {{ formatPrice(orders.plastic_purchase_orders_hold) }}</span>
                      </div>
                      <div class="payment-row display-new-70">
                        <span> Change Rs. </span>
