            ...
            <b-row>
                                    ...
                                    <b-row>
                                        ...
                                        <b-col cols="5">
                                            ...
                                            <vue-barcode class="mt-1 d-flex justify-content-end barcode"
                                                ...
                                                :display-value="false" />
                                            <div>
                                                <h6 class="d-flex justify-content-end display-new-81">Purchasing Note
                                                    (GRN)
                                                </h6>
                                            </div>
                                        </b-col>
                                    ...
                                    <b-row>
                                        ...
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8">
                                                Invoice No <span class="ml-3">: {{ orders.purchas_orders_bill_number }}
                                                </span>
                                            </h6>
                                            <h6 class="font-weight-bolder display-new-8">
                                        ...
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                                                Invoice Date <span class="ml-3"> : {{
                                                    formatDate(orders.purchas_orders_order_date) }} </span>
                                            </h6>
                                            <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                                        ...
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8">
                                                Supplier <span class="ml-5"> <span class="ml-50">: {{
                                                        orders.suppliers_supplier_name.substring(0, 22) }} </span></span>
                                            </h6>
                                        </b-col>
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                                                Lorry Number <span class="ml-1"> <span class="ml-50">: {{
                                                        orders.purchas_orders_lorry_number }} </span></span>
                                            </h6>
                                        </b-col>
                                    ...
                                    <b-col cols="6" class="pr-5">
                                        <div class="payment-box">
                                            ...
                                            <div class="payment-row display-new-70">
                                                ...
                                                <span v-if="orders.purchas_orders_cheque > 0"> {{
                                                    formatPrice(orders.purchas_orders_cheque) }}</span>
                                                <span v-else> -</span>
                                            </div>
                                            <div class="payment-row display-new-70">
                                                <span> Card Payment Rs.</span>
                                                <span v-if="orders.purchas_orders_hold > 0"> {{
                                                    formatPrice(orders.purchas_orders_hold) }}</span>
                                                <span v-else> -</span>
                                            </div>

                                            <div class="payment-row display-new-73">
                                                <span> Credit Rs.</span>
                                                <span v-if="orders.purchas_orders_credit > 0"> {{
                                                    formatPrice(orders.purchas_orders_credit) }}</span>
                                                <span v-else> -</span>
                                            </div>
                                            <!-- <div v-if="orders.purchas_orders_hold > 0"
                ...
                <b-col cols="12" lg="3">
                    ...
                    <b-card class="action-card">
                        ...
                        <b-button variant="danger" block class="action-btn" @click="$router.push('/purches-bill')">
                            Cancel
                        </b-button>
