            ...
            <b-row>
                        ...
                        <b-row>
                            <b-col cols="12">
                                    ...
                                    <b-row>
                                        <b-col cols="7">
                                            <h1 class="mt-50 d-flex">
                                                ...
                                                <span class="mt-1 ml-2"> <span class="display-new-7"> T B S Sarusara
                                                        Products </span>
                                                    <div>
                                        ...
                                        <b-col cols="5">
                                            ...
                                            <vue-barcode class="mt-1 d-flex justify-content-end barcode"
                                                :value="orders.sell_today_sale_orders_bill_number" :format="format"
                                                :height="55" :display-value="false" />
                                            <div>
                                    ...
                                    <b-row>
                                        ...
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8">
                                                Invoice No <span class="ml-3">: {{
                                                    orders.sell_today_sale_orders_bill_number }} </span>
                                            </h6>
                                            <h6 class="font-weight-bolder display-new-8">
                                        ...
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                                                Invoice Date <span class="ml-3"> : {{
                                                    formatDate(orders.sell_today_sale_orders_order_date) }} </span>
                                            </h6>
                                            <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                                        ...
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8">
                                                Company <span class="ml-3"> <span class="ml-50">: {{
                                                        orders.companies_company_name.substring(0, 22) }} </span></span>
                                            </h6>
                                        </b-col>
                                        <b-col cols="6">
                                            <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                                                Lorry Number <span class="ml-3"> <span class="ml-50">: {{
                                                        orders.sell_today_sale_orders_lorry_number }} </span></span>
                                            </h6>
                                        </b-col>
                                ...
                                <div>
                                    <b-row class="mt-2" style="background-color: #999999;">
                                        <b-col class="border border-2 d-flex justify-content-start" cols="6">
                                            <h5 class="p-50  title-table"> No <span class="ml-2"> Description </span>
                                            </h5>
                                        </b-col>
                                ...
                                <b-row>
                                    <b-col cols="6" class="pr-5">
                                        <div class="payment-box">
                                            ...
                                            <div class="payment-row display-new-70">
                                                ...
                                                <span v-if="orders.sell_today_sale_orders_cheque > 0"> {{
                                                    formatPrice(orders.sell_today_sale_orders_cheque) }}</span>
                                                <span v-else> -</span>
                                            </div>

                                                <div class="payment-row display-new-70">
                                                <span> Card Payment Rs.</span>
                                                <span v-if="orders.sell_today_sale_orders_hold > 0"> {{
                                                    formatPrice(orders.sell_today_sale_orders_hold) }}</span>
                                                <span v-else> -</span>
                                            </div>

                                            <div class="payment-row display-new-73">
                                                <span> Credit Rs.</span>
                                                <span v-if="orders.sell_today_sale_orders_credit > 0"> {{
                                                    formatPrice(orders.sell_today_sale_orders_credit) }}</span>
                                                <span v-else> -</span>
                                            </div>
                                            <!-- <div v-if="orders.sell_today_sale_orders_hold > 0"
                                                class="payment-row display-new-70">
                                    ...
                                    <b-col cols="6" class="pl-5">
                                        <div class="payment-box">
                                            ...
                                            <div class="payment-row display-new-70">
                                                <span> Transport </span>
                                                <span v-if="orders.sell_today_sale_orders_transpoart > 0"> {{
                                                    formatPrice(orders.sell_today_sale_orders_transpoart) }}</span>
                                                <span v-else> 0.00</span>
                                            </div>

                                            <div class="payment-row display-new-70">
                                                <span> Labour Charge </span>
                                                <span v-if="orders.sell_today_sale_orders_labour_charge > 0"> {{
                                                    formatPrice(orders.sell_today_sale_orders_labour_charge) }}</span>
                                                <span v-else> 0.00</span>
                                            </div>
                                ...
                                <h1 class="display-new-4 d-flex font-weight-bolder justify-content-center mt-0">
                                    <i> Software By @ Easyones Soft, www.easyonessoft.com Call / Whatsapp : 076 283 38
                                        38 </i>
                                </h1>
                ...
                <b-col cols="12" lg="3">
                    ...
                    <b-card class="action-card">
                        ...
                        <b-button variant="success" block class="action-btn" @click="printInvoice">
                            Print Report
                        </b-button>

                        <b-button variant="danger" block class="action-btn" @click="$router.push('/sales-bill')">
                            Cancel
                        </b-button>
