...
export default {
  ...
  methods: {
    ...
    handleCardClick(project) {
      ...
      this.$router.push(`/view-sell-order/${project.id}`)
      }else{ 
      this.$router.push(`/invoice-sell-order/${project.id}`)
      }
    ...
    async getUsers() {
      try {
        ...
        const Response = await order.getNewSellOrders(
    ...
    async addNewOrder() {
      ...
      try {
        ...
        await order.orderSellCreate(payload)
