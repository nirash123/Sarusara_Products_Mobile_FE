<template>
    ...
    <b-row class="my-2">
        ...
        <b-overlay :show="tableLoading" rounded="sm">
          ...
          <template #cell(id)="data">
            ...
            <template #cell(items_count)="data">
              <div class="d-flex justify-content-center" style="width: 90px !important">
      ...
      <feather-icon
        ...
        icon="EyeIcon"
        size="16"
        @click="$router.push({ name: 'view-payment-hardware-order-list', params: { id: data.item.id }})"
      />
      </b-button>
      <b-button
                    v-ripple.400="'rgba(255, 255, 255, 0.15)'"
    ...
    <feather-icon
      ...
      icon="EditIcon"
      size="16"
      @click="$router.push({ name: 'view-hardware-payment-invoice', params: { id: data.item.id }})"
    />
    </b-button>
      </div>
      </template>
