<template>
  <div>
    <b-card no-body class="p-1 bg-primary rounded p-1">
            <b-row>
              <b-col cols="1">
               <feather-icon @click="$router.push('/return-ordres?tab=3')" icon="ChevronLeftIcon" class="text-white" size="54"/>
              </b-col>
              <b-col cols="10">
                <h3 class="text-white d-flex justify-content-center">
              <span class="mt-1 text-white">Completed Return Order (  H_ORD  {{ this.$route.params.id }} ) </span></h3>
              </b-col>
            </b-row>
          </b-card>
  <b-card>
    ...
    <table class="table table-hover shopping-cart-wrap table-responsive">
                       <thead   >
                          <tr>
                             ...
                             <th scope="col" style="width: 40%">QTY</th>
                             <th scope="col" style="width: 40%">Return Price</th>
