                ...
                <b-col sm="12" md="6" lg="6">
                  ...
                  <b-form-group label-for="user-status">
                    <v-select v-model="form.active_status" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
                      :options="activeStatusOptions" :reduce="val => val.value" :clearable="false" input-id="user-status" />
                  </b-form-group>
                </b-col>
                    <b-col sm="12" md="6" lg="6">
                  <h5 class="text-dark"><b>Vehicle Type</b></h5>
                  <b-form-group label-for="user-status">
                    <v-select v-model="form.status" :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
