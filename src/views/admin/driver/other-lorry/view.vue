      ...
      <div class="position-relative">
        <div class="profile-img-container d-flex align-items-center">
          <div class="profile-img">
            <b-button @click="$router.push('/other-lorry')" v-ripple.400="'rgba(40, 199, 111, 0.15)'" variant='light-white'
          ...
          <b-row>
            ...
            <b-col lg="6" md="6" sm="12">
              <div class="ml-2">
                ...
                <b-card-text>
                  <b-badge style="padding: 8px" variant="light-success">
