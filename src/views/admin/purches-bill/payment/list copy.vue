  ...
  <div class="fixed-page">
    <section class="invoice-preview-wrapper">
      <b-card no-body class="invoice-actions p-1 bg-primary rounded p-1">
        <b-row>
          <b-col cols="1">
            <feather-icon @click="$router.push('/order_list?tab=3')" icon="ChevronLeftIcon" class="text-white"
              size="54" />
          </b-col>
          <b-col cols="10">
            <h3 class="text-white d-flex justify-content-center">
              <span class="mt-1 text-white">Payment Pending Sale Order ( S_ORD {{ this.$route.params.id }} ) </span>
            </h3>
          </b-col>
        </b-row>
      </b-card>
        ...
        <b-row class="invoice-actions">
          <b-col lg="6" md="6" sm="12">
            ...
            <div class="ml-2">
              ...
              <b-card-text>
                <div>
                  Rs: {{ (orders.sale_orders_subtotal).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                </div>
              </b-card-text>
            </div>
            <div class="ml-2">
              ...
              <b-card-text>
                <div>
                  Rs: {{ (orders.sale_orders_discount).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                </div>
              </b-card-text>
            </div>
            <div class="ml-2">
          ...
          <b-col lg="6" md="6" sm="6">
            ...
            <b-button v-if="admin_setting != 1" v-ripple.400="'rgba(186, 191, 199, 0.15)'" variant="primary"
              class="mb-75 mt-2" @click="printInvoice">
              Invoice
            </b-button>
            ...
            <div v-if="orders.sale_orders_card > 0" class="ml-2">
              <h4 class="text-capitalize mt-2">
                Card
              </h4>
              <b-card-text>
                <div>
                  Rs: {{ (orders.sale_orders_card).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                </div>
              </b-card-text>
            </div>
            ...
            <div v-if="orders.sale_orders_credit > 0" class="ml-2">
              <h4 class="text-capitalize mt-2">
                ...
                <b-modal id="modal-prevent-closing-price" centered ref="my-modal-price"
                  :title="`Add New Payment  ( Rs:  ${formattedPrice} )`" ok-title="Submit"
                  ...
                  <form ref="form" @submit.stop.prevent="handleSubmitPrice">
                    ...
                    <b-col sm="12" md="12">
                      <b-form-group label="Cash Amount" label-for="cash" invalid-feedback="Cash is required">
                        <b-form-input id="name" v-model="new_cash" :state="cash_status"
                          placeholder="Enter Cash Amount" />
                      </b-form-group>
                    </b-col>
                    <b-col sm="12" md="12">
                      <b-form-group label="Card Amount" label-for="card" invalid-feedback="Card is required">
                        <b-form-input id="name" v-model="new_card" :state="card_status"
          ...
          <tbody>
            <tr v-for="product in item_orders" :key="product.sale_orders_id">
              ...
              <td>
                <figure class="media">
                  <figcaption class="media-body mt-1">
                    <h6 class="title text-truncate"> {{ product.sale_orders_quentity }} </h6>
                  </figcaption>
                </figure>
              </td>
              <td>
                <figure class="media">
                  <figcaption class="media-body mt-1">
                    <h6 class="title text-truncate">Rs: {{
                      (product.sale_orders_sale_price).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }} </h6>
                  </figcaption>
                </figure>
              </td>
              <td>
                <figure class="media">
                  <figcaption class="media-body mt-1">
                    <h6 class="title text-truncate">Rs: {{ (product.sale_orders_total).replace(/\B(?=(\d{3})+(?!\d))/g,
                      ",") }} </h6>
                  </figcaption>
                </figure>
              </td>
                      ...
                      <b-col cols="11">
                        <div>
                          <div class="d-flex justify-content-center">
                            <b-img src="@/assets/images/logo/slogo.png" width="100px" />
                          </div>
                        ...
                        <b-row class="mt-2">
                          <b-col cols="12">
                            <h1 class="display-new-1  font-weight-bolder  mb-25">
                              බිල්පත් අංකය : {{ orders.sale_orders_bill_number }}
                            </h1>
                          </b-col>
                          <b-col cols="6">
                            <h1 class="display-new-1  font-weight-bolder  mb-25">
                              දිනය : {{ orders.sale_orders_order_date }}
                            </h1>
                          </b-col>
                          <b-col cols="6">
                            <h1 class="display-new-1  font-weight-bolder  mb-25">
                              වේලාව : {{ orders.sale_orders_order_time }}
                            </h1>
                          </b-col>
                          <b-col cols="12">
                            <h1 class="display-new-1  font-weight-bolder  mb-25">
                        ...
                        <div class="mt-50 custom-border">
                          ...
                          <b-row>
                            <b-col cols="2">
                              <h1
                                class="display-new-2 mt-50 ml-5 d-flex justify-content-end  font-weight-bolder  mb-25">
                                ප්‍රමාණය <br>
                                සා. මිල
                              </h1>
                            </b-col>
                            ...
                            <b-row class="mt-50">
                              <b-col cols="11">
                                <h1 class="display-new-3  font-weight-bolder ">
                                  ...
                                  <span v-if="product.unit != 'Pcs'">
                                    | {{ product.sale_orders_quentity }} {{ product.sale_orders_unit }}
                                  </span>
                                  <span v-else>
                                    | {{ Math.round(product.sale_orders_quentity) }} {{ product.sale_orders_unit }}
                                  </span>
                                </h1>
                              </b-col>
                            </b-row>
                            <b-row>
                              <b-col cols="3">
                                <h1 class="display-new-3  d-flex justify-content-end   mb-0">
                                  {{ (product.sale_orders_special_sale_price *
                                    1).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                                </h1>
                              </b-col>
                              <b-col cols="3">
                                <h1
                                  v-if="product.sale_orders_sale_price != product.sale_orders_special_sale_price && product.sale_orders_discount_view == 1"
                                  class="display-new-3  d-flex justify-content-end  font-weight-bolder  mb-0">

                                  {{ (product.sale_orders_sale_price *
                                    1).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                                </h1>
                              </b-col>
                              <b-col cols="3">
                                <h1
                                  ...
                                  {{ ((product.sale_orders_special_sale_price - product.sale_orders_sale_price) *
                                    Math.round(product.sale_orders_quentity)).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g,
                                      ",") }}
                                </h1>
                                <h1
                                  v-if="(product.sale_orders_sale_price != product.sale_orders_special_sale_price) && product.sale_orders_discount_view == 0"
                                  class="display-new-3  d-flex justify-content-end  font-weight-bolder  mb-0">
                              ...
                              <b-col cols="3">
                                <h1 v-if="product.sale_orders_discount_view == 1"
                                  class="display-new-3  d-flex justify-content-end  font-weight-bolder  mb-0">
                                  {{ (product.sale_orders_total).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                                </h1>
                                <h1 v-else class="display-new-3  d-flex justify-content-end  font-weight-bolder  mb-0">
                                  {{ (product.sale_orders_sale_total).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                                </h1>
                              </b-col>
                            </b-row>
                        ...
                        <b-row>
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-3  font-weight-bolder ">
                              <dd class="text-right">
                                {{ (orders.sale_orders_good_discount).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}
                              </dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <b-row>
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-3   ">
                              <dd class="text-right">
                                {{ (order_total).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <b-row>
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-3  font-weight-bolder ">
                              <dd class="text-right">
                                {{ (order_wattam).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <hr class="custom-dashed-border">
                        <b-row class="mt-25">
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-7 font-weight-bolder ">
                              <dd class="text-right mt-1 b">
                                {{ (orders.sale_orders_total).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }} </dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <hr class="custom-dashed-border">
                        <b-row class="mt-25">
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-3 ">
                              <dd class="text-right">
                                {{ (order_cash).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <b-row class="mt-25">
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-3 ">
                              <dd class="text-right">
                                {{ (orders.sale_orders_card).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <b-row v-if="orders.sale_orders_cheque > 0" class="mt-25">
                          <b-col cols="6">
                            <h1 class="display-new-3  ">
                              බැංකු චෙක්පත් :
                            </h1>
                          ...
                          <b-col cols="6">
                            <h1 class="display-new-3 ">
                              <dd class="text-right">
                                {{ (orders.sale_orders_cheque).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</dd>
                            </h1>
                          </b-col>
                        </b-row>
                        ...
                        <b-row>
                          <b-col cols="6">
                            <h1 class="display-new-9 font-weight-bolder  mb-25">
                              ඉතිරි මුදල
                            </h1>
                          </b-col>
                          <b-col cols="6">
                            <h1 class="display-new-9 font-weight-bolder  mb-25">
                              <dd class="text-right">
                                {{ (orders.sale_orders_change).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</dd>
                            </h1>
                          </b-col>
                        </b-row>
                        <b-row class="mt-25">
...
export default {
  ...
  methods: {
    ...
    async companyPrice(new_cash, new_card, new_cheque) {
      ...
      if (this.formattedPrice >= (parseFloat(new_cash) + parseFloat(new_card) + parseFloat(new_cheque))) {
        ...
        try {
          ...
          this.isLoading = true
          const response = await item.submitSaleNewCredit(this.$route.params.id, this.payload)
    ...
    async saleOrderDetails() {
      try {
        const response = await order.saleOrderDetails(this.$route.params.id)
        this.orders = response.data.data
        this.order_cash = parseFloat(this.orders.sale_orders_cash) + parseFloat(this.orders.sale_orders_change)
        this.order_total = parseFloat(this.orders.sale_orders_subtotal) - parseFloat(this.orders.sale_orders_good_discount)
        this.order_wattam = parseFloat(this.order_total) - (parseFloat(this.orders.sale_orders_total))
      } catch (error) {
      }
    },
    ...
    async saleOrderList() {
      try {
        const response = await order.saleOrderList(this.$route.params.id)
