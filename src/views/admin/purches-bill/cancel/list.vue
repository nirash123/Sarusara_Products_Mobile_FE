  ...
  <div class="fixed-page">
    <section class="invoice-preview-wrapper">
      <b-card no-body class="invoice-actions p-1 bg-primary rounded p-1">
        <b-row>
          <b-col cols="1">
            <feather-icon @click="$router.push('/order_list?tab=4')" icon="ChevronLeftIcon" class="text-white"
              size="54" />
          </b-col>
          <b-col cols="10">
            <h3 class="text-white d-flex justify-content-center">
              <span class="mt-1 text-white">Cancelled Order ( {{ orders.sale_orders_bill_number }} ) </span>
            </h3>
          </b-col>
        </b-row>
      </b-card>
              ...
              <b-col cols="12">
                <div>
                  ...
                  <b-row>
                    ...
                    <b-col cols="6">
                      <h6 class="font-weight-bolder display-new-8 d-flex justify-content-end">
                        Lorry Number <span class="ml-2"> <span class="ml-50">: {{ orders.sale_orders_lorry_number }}
                          </span></span>
                      </h6>
                    </b-col>
...
/* keep invoice content above watermark */
.invoice-preview-card > .row {
  position: relative;
  z-index: 2;
}
