  ...
  methods: {
    ...
    async getUsers() {
      try {
        ...
        const Response = await attendence.getTodayPayments(params);
    ...
    async editOrder(id) {
      try {
        ...
        this.$swal({
          ...
          if (result.value) {
            await attendence.attendenceEdit(id)
    ...
    async submitUser(id) {
      try {
        ...
        this.$swal({
          ...
          if (result.value) {
            await attendence.paymentSubmit(id)
            this.showSuccessMessage('Payment has been submitted')
            await this.getUsers();
            this.refreshTable();
          } else if (result.dismiss == 'cancel') {
            this.formLoading = false
