<template>
          ...
          >
            ...
            <b-col sm="12" md="12" >
                  <b-form-group
                      label="Company Name"
                      label-for="shop_name"
                      invalid-feedback="Shop_name required"
                  >
                      <b-form-input
                          ref="codeInput"
                          id="shop_name"
                          v-model="shop_name"
                          :state="shop_name_status"
                ...
                <b-col sm="12" md="12" >
                  <b-form-group
                      ...
                      invalid-feedback="Company Price is required"
                  >
                      <b-form-input
                          id="owner_name"
                          v-model="owner_name"
                          :state="owner_name_status"
  ...
  <feather-icon
    ...
    icon="EyeIcon"
    size="16"
    @click="$router.push({ name: 'view-shop-details', params: { id: data.item.id }})"
  />
  </b-button>
  ...
  <feather-icon
    ...
    icon="EditIcon"
    size="16"
    @click="$router.push({ name: 'edit-shop-details', params: { id: data.item.id }})"
  />
  </b-button>
  ...
  export default {
    ...
    setup() {
      const statusOptions = [
        ...
        { label: 'InActive Companies', value: 2 },
      ]
    ...
    data() {
      ...
      shop_name_status: null,
      owner_name_status: null,
      address_status: null,
    ...
    methods: {
      ...
      checkFormValidityPrice() {
          ...
          this.shop_name_status = valid
          this.owner_name_status = valid
        ...
        resetModalPrice() {
          ...
          this.shop_name_status = null
          this.owner_name_status = null
        ...
        async companyPrice(shop_name,owner_name,address,phone_no,note,) {
          try {
                  this.payload = {
                      shop_name:  shop_name,
                  ...
                  this.isLoading = true
                  const response = await shop.shopCreate(this.payload)
                  this.showSuccessMessage('Create Category Successfully')
                  this.$refs.table.refresh();
                  this.isLoading = false
                } catch (error) {
                  error.response.data.data.shop_name? this.showErrorMessage('The Company name has been already taken.'):''
                  this.isLoading = false
                }
        },
