              ...
              <b-col class="newonegreen" cols="12">
                <div>
                  ...
                  <h3 class="newonetext mb-25 d-flex justify-content-center">
                    <div>Sale Plastic Items Details Report</div>
                  </h3>
                  <h3 class="newonetext mb-25 d-flex justify-content-center">
                    <div>ප්ලාස්ටික් විකුණුම් අයිතම විස්තර</div>
                  </h3>
  ...
  methods: {
    ...
    async dateAdd() {
      try {
        ...
        const status = await invoice.getSalePlasticItemsDetailInvoices(this.payload);
