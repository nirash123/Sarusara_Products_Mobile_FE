                ...
                <div v-for="product in dates" :key="product.id" class="px-2 mt-1">
                  ...
                  <div>
                    ...
                    <h3 class="newonetext mb-25 d-flex justify-content-center">
                      <div>Today Sale Plastic Items Details Report</div>
                    </h3>
                    <h3 class="newonetext mb-25 d-flex justify-content-center">
                      <div>අද දින ප්ලාස්ටික් විකුණුම් අයිතම විස්තර</div>
                    </h3>
  ...
  methods: {
    ...
    async userDetails() {
      try {
        ...
        async add() {
      try {
        const status = await invoice.getTodaySalePlasticItemsDetailInvoices();
