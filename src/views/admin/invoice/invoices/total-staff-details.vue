<template>
          ...
          <b-col class="newonegreen" cols="12">
            <div>
              ...
              <h3 class="newonetext mb-25 d-flex justify-content-center">
               <div>Total Staff Payments Report</div>  
                </h3>
                <h3 class="newonetext mb-25 d-flex justify-content-center">
               <div>කාරයමණ්ඩල මුළු විස්තර</div>  
                </h3>
    ...
    >
      ...
      <b-form-group>
        <h5 class="my-2">Select Date or Date Range :</h5>
        <flat-pickr
          v-model="rangeDate"
  ...
  const status = await invoice.getTotalStaffDetailInvoices(this.payload)
