  ...
  <div class="fixed-page">
    <section class="invoice-preview-wrapper">
      <b-card no-body class="invoice-actions p-1 bg-primary rounded p-1">
        <b-row>
          <b-col cols="1">
            <feather-icon @click="$router.push('/sale-order_list?tab=2')" icon="ChevronLeftIcon" class="text-white" size="54" />
          </b-col>
          <b-col cols="10">
            <h3 class="text-white d-flex justify-content-center">
              <span class="mt-1 text-white">Past Sale Order ( {{ orders.sell_sale_orders_bill_number }} )  </span>
            </h3>
          </b-col>
        </b-row>
      </b-card>
              ...
              <div>
                ...
                <b-row>
                  ...
                  <b-col cols="5">
                    ...
                    <vue-barcode class="mt-1 d-flex justify-content-end barcode" :value="orders.sell_sale_orders_bill_number"
              ...
              <b-row>
                ...
                <b-col cols="6" class="pl-5">
                  <div class="payment-box">
                    ...
                    <div class="payment-row display-new-70">
                      <span> Transport </span>
                      <span v-if="orders.sell_sale_orders_transpoart > 0"> {{ formatPrice(orders.sell_sale_orders_transpoart) }}</span>
                      <span v-else> 0.00</span>
                    </div>

                    <div class="payment-row display-new-70">
                      <span> Labour Charge </span>
                      <span v-if="orders.sell_sale_orders_labour_charge > 0"> {{ formatPrice(orders.sell_sale_orders_labour_charge) }}</span>
                      <span v-else> 0.00</span>
                    </div>
