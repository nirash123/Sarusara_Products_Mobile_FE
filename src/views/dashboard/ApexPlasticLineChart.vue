      ...
      <b-col cols="12" md="6" class="d-flex justify-content-start">
        <div>
          <b-card-title class="mb-1">
            විශ්ලේෂණය - ( අද දින ප්ලාස්ටික් ගැණුම් ප්‍රමාණය )
          </b-card-title>
        </div>
      </b-col>
    </b-row>
  ...
  methods: {
    async categoryAdd() {
      try {
        ...
        const response = await invoice.getTodayPlasticItemPurchasDetails();
